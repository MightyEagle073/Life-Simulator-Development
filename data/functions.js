...
//Function 4: applyTheme() - Switches the background of the webpage and on the settings button
function applyTheme() {
...
//Function 7: displayType() - Changes the display type of the following element
function displayType(overlayName, displayType) {
    $("#" + overlayName).css("display", displayType);
}

//Function 8: playAudio() - Plays audio
