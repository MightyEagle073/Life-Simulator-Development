...
function career_effort_update() {
    ...
    if (effort == 0) {
        ...
        $("#career_effort_warning").html(`WARNING: Putting no effort into working might get you demoted or fired!`);
        ...
        $("#career_effort_warning").html(`WARNING: Putting this much effort into working is extremely stressful and might cause depression!`);
    }
}
